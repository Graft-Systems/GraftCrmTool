import {
  ...
  createTaskAction,
  updateTaskAction,
} from "@/app/(dashboard)/work-actions";
...
export function TaskSection({ companyId, contacts, users, deals, pilots, tasks }: TaskSectionProps) {
    ...
    <section className="space-y-6">
          ...
          tasks.map((task) => (
            ...
            >
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor={`task-dealId-${task.id}`}>Deal</Label>
                  <select
                ...
                <div className="space-y-2">
                  <Label htmlFor={`task-pilotId-${task.id}`}>Pilot</Label>
                  <select
                    id={`task-pilotId-${task.id}`}
                    name="pilotId"
                    defaultValue={task.pilot?.id ?? ""}
                    className={selectClassName}
                  >
      ...
      <div className="rounded-xl border bg-background p-4">
        ...
        <form action={createTaskAction.bind(null, companyId)} className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="new-task-dealId">Deal</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="new-task-pilotId">Pilot</Label>
            <select id="new-task-pilotId" name="pilotId" defaultValue="" className={selectClassName}>
              <option value="">No linked pilot</option>
              {pilots.map((pilot) => (
                <option key={pilot.id} value={pilot.id}>
                  {pilot.name}
